        ...
        $.get('/index.php/storagelocation/index', {
            u: $('#collection_parent_node_id').val()},
                function (storageLocation) {
                    var selectedLocation = $('#collection_storage_locations_list').val();
...
//                                } else {
                                    var selected = '';
                                    if (jQuery.inArray(storageLocation[i].id, selectedLocation) !== -1) {
                                        selected = 'selected="selected"';
                                    }
                                    $('#collection_storage_locations_list').append('<option value="' + storageLocation[i].id + '" ' + selected + '>' + storageLocation[i].name + '</option>');
//                                }
                            }
                        }
