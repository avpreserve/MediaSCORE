...
/**
 * CollectionMultipleAssetGroup form base class.
 *
 * @method CollectionMultipleAssetGroup getObject() Returns the current form's model object
 *
 * @package    mediaSCORE
 * @subpackage form
 ...
 */
abstract class BaseCollectionMultipleAssetGroupForm extends SubUnitForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('collection_multiple_asset_group[%s]');
  }

  public function getModelName()
  {
    return 'CollectionMultipleAssetGroup';
  }
