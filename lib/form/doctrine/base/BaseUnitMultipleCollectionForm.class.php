...
/**
 * UnitMultipleCollection form base class.
 *
 * @method UnitMultipleCollection getObject() Returns the current form's model object
 *
 * @package    mediaSCORE
 * @subpackage form
 ...
 */
abstract class BaseUnitMultipleCollectionForm extends StoreForm
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('unit_multiple_collection[%s]');
  }

  public function getModelName()
  {
    return 'UnitMultipleCollection';
  }
