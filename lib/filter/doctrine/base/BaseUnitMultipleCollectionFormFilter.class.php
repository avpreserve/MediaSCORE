...
/**
 * UnitMultipleCollection filter form base class.
 *
 * @package    mediaSCORE
 * @subpackage filter
 ...
 */
abstract class BaseUnitMultipleCollectionFormFilter extends StoreFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('unit_multiple_collection_filters[%s]');
  }
