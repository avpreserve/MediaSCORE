...
/**
 * CollectionMultipleAssetGroup filter form base class.
 *
 * @package    mediaSCORE
 * @subpackage filter
 ...
 */
abstract class BaseCollectionMultipleAssetGroupFormFilter extends SubUnitFormFilter
{
  protected function setupInheritance()
  {
    ...
    $this->widgetSchema->setNameFormat('collection_multiple_asset_group_filters[%s]');
  }
